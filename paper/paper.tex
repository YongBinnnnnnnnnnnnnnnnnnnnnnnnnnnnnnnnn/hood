...
\paragraph{}
This paper explains the decisions behind the hardware and the operating system in \cref{cha:hard} and explains the decisions behind how packets are forwarded in \cref{cha:packet}. In \cref{cha:dhcp, cha:dns, cha:tls}, the deficiency of the protocols are explained and the solutions are provided. In \cref{cha:plaintext},
