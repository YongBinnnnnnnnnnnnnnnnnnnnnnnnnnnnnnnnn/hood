...
\DeclareCaptionType{itemlist}[List][List of Lists]
...
\begin{itemlist}[H]
  ...
  \end{enumerate}
  \captionof{itemlist}{Some facts to show the possibilities of surveillance}
\end{itemlist}
...
\begin{itemlist}[H]
  ...
  \end{itemize}
  \captionof{itemlist}{Allowed cipher suites values}
...
\begin{itemlist}[H]
  ...
  \end{itemize}
  \captionof{itemlist}{Firewall rules to be added for LAN ports}
  \label{lst:LAN-rules}
\end{itemlist}
\paragraph{}
...
\begin{itemlist}[H]
  ...
  \end{itemize}
  \captionof{itemlist}{Files deleted from target to disable wireless}
...
\begin{itemlist}[H]
  ...
  \end{itemize}
  \captionof{itemlist}{Files deleted from target to disable GPU}
...
\paragraph{}
The mentions counted in this section are from security releases, which means the components that did not cause a security issue would not be mentioned. Thus, the high number of mentions in this section represent high chance of causing problems. Some people interpret high number of mentions as something has been more closely checked, and more vulnerabilities have also been fixed. They may have been more frequently checked by maintainers and users but may also have been more frequently checked by attackers. The data collected in this section are from 2020 to 2024, years after the initial release of those tools and technologies. Which means after all these years, they are still causing vulnerabilities more frequently than others. In a reasearch about zero day vulnerabilities published by the RAND Corporation, they found no characteristics of a vulnerability indicated a long or short life and only 25 percent of vulnerabilities do not survive to 1.51 years \citep{zeroday:life}. It shows that even if a new research shows the high number of mentions in security releases implies short life of vulnerabilities, the vulnerabilities may still survive 1.5 years and 1.5 years is long enough for me to consider to move away from this active volcano.
\begin{figure}[H]
