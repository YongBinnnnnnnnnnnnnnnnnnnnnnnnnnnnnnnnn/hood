...
\title{Design and implementation of a firewall system for working in unsafe environments with strong opposing forces} %compulsory
...
\paragraph{}
Hood is designed to work as a USB ethernet device so people do not need to connect many cables. See \cref{fig:hardware-deployment-view}.
\begin{figure}[H]
  \includegraphics[]{graphics/puml/hardware-deployment-view.png}
  \caption{Hardware deployment view}
