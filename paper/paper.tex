...
\end{figure}
\paragraph{}
I collected texts of Apple security releases of its operating systems between Januray 8th 2020 and Januray 12th 2024 from Apple website and then counted the number of times of an component being mentioned in their security releases. See \cref{fig:apple-sec-release}. They are the top 19 mostly mentioned components with one exception: the number of "Wi-Fi + Bluetooth" is the sum of the two.
\paragraph{}
...
\end{figure}
\paragraph{}
I also collected package names of Fedora 39 security updates between Feburary 14th 2020 and Januray 10th 2024 and then counted the number of times of a prefix being mentioned in their security releases. See \cref{fig:fedora-sec-update}. The result also proves the high-risk of browsers: both firefox and chromium are on the list.
