...
\paragraph{}
To be close to real-world application of this tool, a computer from the university classroom is used to test the firewall. It has remote management tools pre-installed and I do not have the administrator permission to configure the computer or to install some protection tools. Thus, without the help from the firewall, there are not much things I can do. 
\section{mitm-proxy}
\section{metasploit}
\section{blah blah}
