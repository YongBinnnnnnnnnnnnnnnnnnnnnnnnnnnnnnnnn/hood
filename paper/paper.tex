...
\section{IPv6}
\paragraph{}
This section explains why firewall disables IPv6. I searched both the keyword "IPv6" and the keyword "IPv4" from the website \url{https://cve.mitre.org}. On Jan 14th 2024 (UTC +1) 00:00, there are 615 CVE records that match "IPv6" and 360 CVE records that match "IPv4".
