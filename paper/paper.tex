...
\paragraph{}
To make computers recognize the firewall as a USB device, the support from both thUpdate paper.texe hardware and the operating systems (OS) are required.
\paragraph{}
...
\subsection{Design}
\paragraph{}
The firewall should trust only the CAs that are being widely used on the internet. It now respects th usage statistics of SSL certificate authorities for websites published by W3Techs \citep{cert:stat}. People should be able to further decide which certificates to trust. Consider untrust following CAs when making such decisions: the CAs of the place you are staying, the CAs of the place you come from, and their enemies and allies.
