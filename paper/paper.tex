...
\paragraph{}
Dispatcher is a shell script named 02-hood-dispatcher. It interacts with the changes of the network status or the system status to dynamically configure firewall rules and to start or stop netowrk services. It's callers are two sysrtemctl services: before-network.service (See \cref{sec:before-network-service}) and NetworkManager-dispatcher.service.
