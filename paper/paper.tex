...
\end{figure}
\paragraph{}
As the results of the second experiment, Wireshark captured plaintext requests and plaintext responses of both the DNS query to example.com and the HTTP request to example.com.

\subsection{Conclusions}
As conclusion, the "hood" firewall successfully protected against eavesdropping attacks against plaintext HTTP traffic and plaintext DNS traffic.
