...
\section{IPv6}
\paragraph{}
This section explains why firewall disables IPv6. I searched both the keyword "IPv6" and the keyword "IPv4" from the website \url{https://cve.mitre.org}. There are 615 CVE Records that match "IPv6" and 360 CVE Records that match "IPv4".
