...
\paragraph{}
This chapter provides reasons of many things that could bring convenience were disabled in the firewall by analyzing security events.

\begin{figure}[H]
  \includegraphics[scale=1]{data/apple_security_releases/result.png}
  \caption{Top 15 times of an component being mentioned in Apple security releases\newline from Januray 8th 2020 to Januray 12th 2024}
