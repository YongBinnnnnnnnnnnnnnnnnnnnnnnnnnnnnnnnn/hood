...
\section{Analyzation to security events}
\begin{figure}[H]
...
\end{figure}
\paragraph{}
I collected texts of Apple security releases of its operating systems between Januray 8th 2020 and Januray 12th 2024 from Apple website and then counted the number of times of an component being mentioned in their security releases. See \cref{fig:apple-sec-release}. The result shows that 
