...
\paragraph{}
To make computers recognize the firewall as a USB device, the support from both the development board and the operating systems (OS) are requiresd.
\paragraph{}
...
In conclusion, Raspberry Pi 4B has sufficient hardware and software support to make it work as the USB device designed in the previous section. Its price is also much lower than the majority of commercial firewalls. It is not the cheapest option that can fit the design but it is a good choice after taking technical support and user base into consideration.
